...
enum TambahLaporanState { add, edit }
...
class _TambahLaporanState extends State<TambahLaporan> {
  ...
  String _latitudeState, _longitudeState;
  ...
  Future<void> _initialization() async {
    ...
    if (!_isIDLaporanNull && !_isStateNull) {
      if (_state == TambahLaporanState.edit) {
        await _editLaporanInitialization();
      }
    } else {
  ...
  Future<void> _editLaporanInitialization() async {
    int _idLaporan = widget.idLaporan;
    ...
    if (_detailLaporan != null) {
      ...
      int _luasTanam = _detailLaporan['luas'];
      ...
      List _kecamatanWilKer =
          await DPIFuture.getKecamatanWilayahKerja(idUser: _idUser);
      _kecamatanWilKer =
          _kecamatanWilKer.map((kecamatan) => kecamatan['kecamatan']).toList();

      List _desaWilKer =
          await DPIFuture.getDesaWilayahKerja(idKecamatan: _kecamatanTerpilih);
      ...
      setState(() {
        ...
        _pickedFileState =
            PickedFile(ServerPath.apiBaseURL + '/elapor/' + _fotoLaporan);
      });
    }
  }
  ...
  void _calculateJumlahSisaSerangan() {
    int _intSPSSRingan =
        (_sspsRingan.text.length >= 1) ? int.parse(_sspsRingan.text) : 0;
    int _intSPSSSedang =
        (_sspsSedang.text.length >= 1) ? int.parse(_sspsSedang.text) : 0;
    int _intSPSSBerat =
        (_sspsBerat.text.length >= 1) ? int.parse(_sspsBerat.text) : 0;
    int _intSPSSPuso =
        (_sspsPuso.text.length >= 1) ? int.parse(_sspsPuso.text) : 0;
  ...
  void _calculateLuasTambahSerangan() {
    int _intLTSPPLRingan =
        (_ltspplRingan.text.length >= 1) ? int.parse(_ltspplRingan.text) : 0;
    int _intLTSPPLSedang =
        (_ltspplSedang.text.length >= 1) ? int.parse(_ltspplSedang.text) : 0;
    int _intLTSPPLBerat =
        (_ltspplBerat.text.length >= 1) ? int.parse(_ltspplBerat.text) : 0;
    int _intLTSPPLPuso =
        (_ltspplPuso.text.length >= 1) ? int.parse(_ltspplPuso.text) : 0;
  ...
  void _calculateJumlahLuasPengendalian() {
    int _intPestisidaHayati = (_pestisidaHayatiController.text.length >= 1)
        ? int.parse(_pestisidaHayatiController.text)
        : 0;
    int _intPestisidaKimia = (_pestisidaKimiaController.text.length >= 1)
        ? int.parse(_pestisidaKimiaController.text)
        : 0;
    int _intEradikasi = (_eradikasiController.text.length >= 1)
        ? int.parse(_eradikasiController.text)
        : 0;
    int _intCaraLain = (_caraLainController.text.length >= 1)
        ? int.parse(_caraLainController.text)
        : 0;
                                  ...
                                  ? Padding(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                fit: BoxFit.contain,
                                                image: (_idLaporan != null)
                                                    ? NetworkImage(
                                                        _pickedFileState.path)
                                                    : FileImage(File(
                                                        _pickedFileState
                                                            .path))),
                                            borderRadius:
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomForm.selectBox(context,
                                          ...
                                          int _idKabupaten = _dataLogin[
                                              SPKey.kabupatenKotaUser];

                                          List _kelurahanWilKer =
                                              await DPIFuture
                                                  .getDesaWilayahKerja(
                                                      idProvinsi: _idProvinsi,
                                                      idKabupaten: _idKabupaten,
                                                      idKecamatan:
                                                          _kecamatanSelected);
                                          _kelurahanWilKer = _kelurahanWilKer
                                              .map((desa) => desa['desa'])
                                              .toList();
                                          print(_kecamatanSelected);
                                          setState(() {
                                            _kelurahanState = _kelurahanWilKer;
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomForm.selectBox(context,
                                          ...
                                          await _getOPT(
                                              komoditas: newValue,
                                              kriteria: _kriteriaOPTSelected);
                                          setState(() {
                                            _komoditasSelected = newValue;
                                          });
                                        })
                                      ],
                                    )),
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        CustomForm.textFieldLabel(context,
                                            label:
                                                'Sisa Serangan Periode Sebelumnya (Ringan) (ha)',
                                            letterSpacing: 1.5,
                                            color: CustomColors.eLaporBlack),
                                        SizedBox(height: _labelAndFormSpacing),
                                        CustomForm.textField(context,
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        CustomForm.textFieldLabel(context,
                                            label:
                                                'Sisa Serangan Periode Sebelumnya (Sedang) (ha)',
                                            letterSpacing: 1.5,
                                            color: CustomColors.eLaporBlack),
                                        SizedBox(height: _labelAndFormSpacing),
                                        CustomForm.textField(context,
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        CustomForm.textFieldLabel(context,
                                            label:
                                                'Sisa Serangan Periode Sebelumnya (Berat) (ha)',
                                            letterSpacing: 1.5,
                                            color: CustomColors.eLaporBlack),
                                        SizedBox(height: _labelAndFormSpacing),
                                        CustomForm.textField(context,
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        CustomForm.textFieldLabel(context,
                                            label:
                                                'Sisa Serangan Periode Sebelumnya (Puso) (ha)',
                                            letterSpacing: 1.5,
                                            color: CustomColors.eLaporBlack),
                                        SizedBox(height: _labelAndFormSpacing),
                                        CustomForm.textField(context,
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomForm.textField(context,
                                            ...
                                            enabled: false,
                                            borderColor: _borderColor,
                                            hintText: 'Jumlah Sisa Serangan',
                                            controller: _jumlahSSPSController)
                                      ]),
                                ),
                                Padding(
                                  padding: EdgeInsets.only(top: _paddingTop),
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomForm.textField(context,
                                            ...
                                            borderColor: _borderColor,
                                            hintText: 'Masukkan Nilai',
                                            controller: _jumlahLTSPPLController)
                                      ]),
                                ),
                                Padding(
                                  padding: EdgeInsets.only(top: _paddingTop),
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomForm.textField(context,
                                            ...
                                            borderColor: _borderColor,
                                            hintText: 'Masukkan Nilai',
                                            controller: _eradikasiController,
                                            onEditingComplete: () {
                                              _focusScope.nextFocus();
                                            },
                                            onChange: (value) =>
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomForm.textField(context,
                                            ...
                                            borderColor: _borderColor,
                                            hintText: 'Masukkan Nilai',
                                            controller: _caraLainController,
                                            onEditingComplete: () {
                                              _focusScope.nextFocus();
                                            },
                                            onChange: (value) =>
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomForm.textField(context,
                                            ...
                                            enabled: false,
                                            hintText: 'Masukkan Nilai',
                                            controller: _jumlahLuasPengendalian)
                                      ]),
                                ),
                                Padding(
                                  padding: EdgeInsets.only(top: _paddingTop),
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomForm.textField(context,
                                            ...
                                            hintText: 'Masukkan Nilai',
                                            enabled: false,
                                            controller: _lKSPPLRinganController,
                                            onEditingComplete: () {
                                          _focusScope.nextFocus();
                                        })
                                      ]),
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomForm.textField(context,
                                            ...
                                            borderColor: _borderColor,
                                            hintText: 'Masukkan Nilai',
                                            controller: _lKSPPLSedangController,
                                            onEditingComplete: () {
                                          _focusScope.nextFocus();
                                        })
                                      ]),
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomForm.textField(context,
                                            ...
                                            borderColor: _borderColor,
                                            hintText: 'Masukkan Nilai',
                                            controller: _lKSPPLBeratController,
                                            onEditingComplete: () {
                                          _focusScope.nextFocus();
                                        })
                                      ]),
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomForm.textField(context,
                                            ...
                                            borderColor: _borderColor,
                                            hintText: 'Masukkan Nilai',
                                            controller: _lKSPPLPusoController,
                                            onEditingComplete: () {
                                          _focusScope.nextFocus();
                                        })
                                      ]),
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomForm.textField(context,
                                            ...
                                            controller: _jumlahLKSPPLController)
                                      ]),
                                ),
                                (_showOkmarAsep)
                                    ? Padding(
                                  ...
                                  ? Padding(
                                      ...
                                      child: Button.submitButton(
                                        ...
                                        if (_pickedFileState != null) {
                                          String _savePath =
                                              (_idLaporan != null)
                                                  ? ServerPath.updaetOPTPath
                                                  : ServerPath.saveOPTPath;
                                          ...
                                          int _provinsiUser =
                                              _dataLogin[SPKey.provinsiUser];
                                          int _kabupatenKotaUser = _dataLogin[
                                              SPKey.kabupatenKotaUser];

                                          int _bulan =
                                              int.parse(_bulanController.text);
                                          int _tahun =
                                              int.parse(_tahunController.text);
                                          ...
                                          Map<String, dynamic> _dataToSend = {
                                            ...
                                            'umur': _umurTanamanController.text,
                                            'luas': _luasTanamController.text,
                                            'kriteria': _kriteriaOPTSelected,
                                            'opt': _optSelected,
                                            ...
                                            'sisa_serangan_luas_terkendali':
                                                _luasTerkendaliController.text,
                                            ...
                                            'luas_pengendalian_kimia':
                                                _pestisidaKimiaController.text,
                                            'luas_pengendalian_hayati':
                                                _pestisidaHayatiController.text,
                                            ...
                                            'luas_pengendalian_jumlah':
                                                _jumlahLuasPengendalian.text,
                                            'luas_keadaan_ringan':
                                                _lKSPPLRinganController.text,
                                            'luas_keadaan_sedang':
                                                _lKSPPLSedangController.text,
                                            'luas_keadaan_berat':
                                                _lKSPPLBeratController.text,
                                            'luas_keadaan_puso':
                                                _lKSPPLPusoController.text,
                                            'luas_keadaan_jumlah':
                                                _jumlahLKSPPLController.text,
                                            'periode_okmar_asep':
                                                _periodeOkmarAsepController
                                                    .text,
                                          ...
                                          if (_idLaporan != null) {
                                            _dataToSend['id'] = _idLaporan;
                                          }

                                          _dataToSend.forEach((key, value) {
